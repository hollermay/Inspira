...
return (
    <div className='items-center justify-center'>
            <h1 className='text-center font-bold text-3xl bg-clip-text bg-gradient-to-l from-pink-600 to-red-500 text-transparent'>Browse from a wide range of our templates!</h1>
                    
                    <div className="flex flex-wrap my-6 justify-center flex-row gap-8">
